...
type SortField = 'accessKey' | 'user' | 'createdAt' | 'type'
  ...
  const sortedKeys = useMemo(() => {
    ...
    sorted.sort((a, b) => {
      ...
      switch (sortField) {
        ...
        case 'user': cmp = (a.userId || '').localeCompare(b.userId || ''); break
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <SortHeader field="user" label={t('keys.userId')} />
              ...
              {sortedKeys.map((k) => (
                <tr key={k.accessKey} className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                  ...
                  <td className="px-4 py-3 text-gray-700 dark:text-gray-300">
                    {k.userId || (k.isAdmin
                      ? <span className="text-gray-400 dark:text-gray-500">{t('keys.builtIn')}</span>
                      : null)}
                  </td>
