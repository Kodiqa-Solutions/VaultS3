...
```bash
# Debian or Ubuntu
sudo apt install ./vaults3_4.4.74_amd64.deb
# RHEL, Rocky or Fedora
sudo rpm -i vaults3-4.4.74-1.x86_64.rpm
# Alpine
sudo apk add --allow-untrusted vaults3_4.4.74_x86_64.apk
...
```bash
gh attestation verify vaults3_4.4.74_amd64.deb --repo Kodiqa-Solutions/VaultS3
```
